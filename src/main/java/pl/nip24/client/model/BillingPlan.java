...
public class BillingPlan {
  ...
  @JsonProperty("funcGetKRSData")
  private Boolean funcGetKRSData = null;

  @JsonProperty("funcGetKRSSection")
  private Boolean funcGetKRSSection = null;
  ...
  **/
  ...
  public BillingPlan funcGetKRSData(Boolean funcGetKRSData) {
    this.funcGetKRSData = funcGetKRSData;
    return this;
  }

   /**
   * Get funcGetKRSData
   * @return funcGetKRSData
  **/
  @Schema(required = true, description = "")
  public Boolean isFuncGetKRSData() {
    return funcGetKRSData;
  }

  public void setFuncGetKRSData(Boolean funcGetKRSData) {
    this.funcGetKRSData = funcGetKRSData;
  }

  public BillingPlan funcGetKRSSection(Boolean funcGetKRSSection) {
    this.funcGetKRSSection = funcGetKRSSection;
    return this;
  }

   /**
   * Get funcGetKRSSection
   * @return funcGetKRSSection
  **/
  @Schema(required = true, description = "")
  public Boolean isFuncGetKRSSection() {
    return funcGetKRSSection;
  }

  public void setFuncGetKRSSection(Boolean funcGetKRSSection) {
    this.funcGetKRSSection = funcGetKRSSection;
  }
  ...
  public String toString() {
    ...
    sb.append("    funcGetKRSData: ").append(toIndentedString(funcGetKRSData)).append("\n");
    sb.append("    funcGetKRSSection: ").append(toIndentedString(funcGetKRSSection)).append("\n");
    sb.append("}");
    return sb.toString();
  }
